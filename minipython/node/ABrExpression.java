...
public final class ABrExpression extends PExpression
{
    ...
    {
        ((Analysis) sw).caseABrExpression(this);
    }
    ...
    private class ComExp_Cast implements Cast
    {
        public Object cast(Object o)
        {
            ...
            if((node.parent() != null) &&
                (node.parent() != ABrExpression.this))
            {
                node.parent().removeChild(node);
            }
